...
Prompt Drawer هو مشغل prompts محلي لسطح المكتب، مخصص للأشخاص الذين يستخدمون prompts منظمة بشكل متكرر داخل وكلاء البرمجة وأدوات المحادثة. يحتفظ التطبيق بزر Prompt Drawer عائم قرب منطقة الإدخال الحالية، ويفتح لوحة prompts مدمجة، ثم يدرج prompt الذي تختاره في التطبيق المستهدف.
