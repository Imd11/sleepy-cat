...
Prompt Drawer هو مكتبة prompts محلية لتطبيقات سطح المكتب والطرفية وأدوات الذكاء الاصطناعي في المتصفح، بما فيها Codex وCursor وClaude وChatGPT وGemini وغيرها. اختر prompt محفوظاً، فيملؤه Prompt Drawer في حقل الإدخال النشط ويرسله بإجراء واحد. لا حاجة إلى النسخ واللصق والضغط على Return كل مرة. اختر **إدراج فقط** عندما تريد مراجعة المحتوى قبل الإرسال.
