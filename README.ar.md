...
![عرض Prompt Drawer](docs/prompt-drawer-demo.gif)
...
Prompt Drawer هو مكتبة prompts محلية لـ Codex وCursor وسطر الأوامر (CLI). اختر prompt محفوظاً، فيملؤه Prompt Drawer في حقل الإدخال النشط ويرسله بإجراء واحد. لا حاجة إلى النسخ واللصق والضغط على Return كل مرة. اختر **إدراج فقط** عندما تريد مراجعة المحتوى قبل الإرسال.
...
3. افتح Prompt Drawer واختر prompt أو مجموعة.
...
يحفظ Prompt Drawer مكتبتك محلياً ولا يرفع محتوى prompts إلى خادم. استورد أو صدّر مكتبات JSON عندما تحتاج إلى نسخة احتياطية أو تريد نقل prompts.
