...
Prompt Drawer 是一个适用于桌面应用、终端和浏览器 AI 工具的本地提示词库，支持 Codex、Cursor、Claude、ChatGPT、Gemini 等常用工具。直接从自己的提示词库中选择一条提示词，Prompt Drawer 就能自动填入当前输入框并发送，无需反复复制、粘贴和按回车。需要先检查内容时，也可以切换为“只填入”。
...
2. 将焦点放在需要工作的输入框中。
3. 打开 Prompt Drawer，选择一条提示词或提示词组。
